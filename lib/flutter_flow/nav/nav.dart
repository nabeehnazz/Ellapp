...
class AppStateNotifier extends ChangeNotifier {
  EllappFirebaseUser? initialUser;
  EllappFirebaseUser? user;
  ...
  void update(EllappFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? NavBarPage() : PhoneWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'proflle',
              requireAuth: true,
              builder: (context, params) => ProflleWidget(),
            ),
            FFRoute(
              name: 'booking',
              path: 'ticketsNavbar',
            ...
            FFRoute(
              ...
              path: 'servicetype',
              requireAuth: true,
              builder: (context, params) => ServicetypeWidget(),
            ),
            FFRoute(
              name: 'Servicelist',
              path: 'servicelist',
